# RESCAT — sistema de producto

## Dirección

RESCAT se presenta como una red urbana de rescate alimentario, no como una campaña ecológica genérica. La interfaz debe funcionar bajo luz intensa en la calle para clientes y con alta densidad operativa detrás del mostrador para comercios.
...
- Fondo: `oklch(0.975 0.004 145)`
- Tinta: `oklch(0.255 0.055 155)`
- Acción: `oklch(0.47 0.12 153)`
- Señal: `oklch(0.91 0.19 112)`
- Riesgo: `oklch(0.61 0.19 32)`
- Radio de producto: 8–12 px; las pills se reservan para filtros y estados.
- Movimiento: 150–200 ms para feedback de estado, siempre con alternativa de movimiento reducido.
